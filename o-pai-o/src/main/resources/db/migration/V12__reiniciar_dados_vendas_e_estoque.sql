...
INSERT INTO produtos (nome, preco, unidade, categoria_id, fornecedor_id, ativo, data_criacao) VALUES
                                                                                                  ('Cerveja Heineken Long Neck 330ml', 12.00, 'UN', 1, 1, true, CURRENT_TIMESTAMP), -- ID: 1
                                                                                                  ('Chopp Brahma Claro 300ml', 9.50, 'UN', 1, 1, true, CURRENT_TIMESTAMP),       -- ID: 2
                                                                                                  ('Caipirinha de Limão Tradicional', 18.00, 'UN', 2, 2, true, CURRENT_TIMESTAMP), -- ID: 3
                                                                                                  ('Batata Frita com Queijo e Bacon', 38.90, 'PORCAO', 3, 2, true, CURRENT_TIMESTAMP), -- ID: 4
                                                                                                  ('Picanha na Chapa com Mandioca', 89.90, 'PORCAO', 3, 2, true, CURRENT_TIMESTAMP),  -- ID: 5
                                                                                                  ('Coca-Cola Lata 350ml', 6.00, 'UN', 4, 3, true, CURRENT_TIMESTAMP);           -- ID: 6
...
INSERT INTO comandas (numero_mesa, nome_cliente, status, valor_total, data_abertura) VALUES
                                                                                         (5, 'Bruno Silva', 'ABERTA', 45.50, CURRENT_TIMESTAMP),   -- ID: 1
                                                                                         (12, 'Grupo de Sexta', 'ABERTA', 125.80, CURRENT_TIMESTAMP), -- ID: 2
                                                                                         (3, 'Mariana Costa', 'ABERTA', 0.00, CURRENT_TIMESTAMP);  -- ID: 3
...
INSERT INTO vendas (usuario_id, formaDePagamento_id, valor_total, status, data_criacao) VALUES
                                                                                            (2, 4, 57.50, 'ABERTA', CURRENT_TIMESTAMP), -- ID: 1
                                                                                            (1, 1, 113.90, 'ABERTA', CURRENT_TIMESTAMP); -- ID: 2
